    ...
    <main class="site-main">
      <div class="container">
        ...
        <section class="top-card">
          ...
          <div class="info">
            ...
            <div class="info-grid">
              ...
              <div class="box">강사: ${tname}</div>
              <div class="box">강의분류: ${lcate}</div>
              <div class="box">강의Level: ${llevel}</div>
            </div>

			<form action="${cp}/lesson/enroll" method="post" class="enroll">
			  <input type="hidden" name="lno" value="${lesson.lno}"/>
			  <button type="submit" class="btn btn-primary">수강하기</button>
			</form>
        ...
        <section class="lesson-list">
          <c:forEach var="w" items="${weeks}" varStatus="st">
            <div class="lesson-item">
              <div class="lesson-week">
                <span class="badge-week">${st.index + 1}주차</span>
              </div>
              <div class="lesson-title">${w.wname}</div>
            </div>
          </c:forEach>
        </section>
